...
const events = [
  {
    id: 1,
    title: "Праздничное шествие ветеранов",
    body: "Это макетное описание мероприятия 1. Здесь будет подробная информация о событии, участниках и программе. Можно заменить текст на реальный позже.",
    image: "img/emblem.png"
  },
];
